...
function LCD(opts) {
  ...
  // TODO: Move to device map profile
  this.board.digitalWrite(this.pins.rs, this.io.LOW);
  this.board.digitalWrite(this.pins.en, this.io.LOW);
...
LCD.hilo = function(callback) {
  ...
  this.board.digitalWrite(this.pins.rs, this.io.HIGH);
...
LCD.prototype.pulse = function() {
  ["LOW", "HIGH", "LOW"].forEach(function(val, i) {
    this.board.digitalWrite(this.pins.en, this.io[val]);
  }, this);
